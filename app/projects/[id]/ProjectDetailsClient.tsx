          ...
          <div className="bg-white rounded-3xl p-6 md:p-8 border border-black/[0.04] shadow-sm space-y-6">
            ...
            <div className="text-primary/80 text-sm leading-relaxed whitespace-pre-line font-medium space-y-4">
              {project.description ? (
                ...
                `Godrej properties is proud to announce ${project.name} in Pune's highly sought-after destination ${project.location}. Designed for families seeking contemporary lifestyles combined with elite configurations of ${project.typology}. This project integrates state-of-the-art infrastructure, sustainable elements, and direct highway connectivities to create premium investment and living assets.`
              )}
            </div>
          </div>
